...
img, w, h = read_ppm("practice.ppm")

#brighten
bright = brightness(img, 50)
write_ppm("bright.ppm", bright, w, h)

#darken
dark = brightness(img, -100)
write_ppm("darken.ppm", dark, w, h)


#contrast
contrast = contrast(img, 1.5)
write_ppm("contrast.ppm", contrast, w, h)


#threshold
thresh = threshold_rgb(img, 128)
write_ppm("threshold.ppm", thresh, w, h)

#negative
neg = negative_rgb(img)
write_ppm("negative.ppm", neg, w, h)
